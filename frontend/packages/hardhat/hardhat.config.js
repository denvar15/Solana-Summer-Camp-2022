...
const deployerPrivateKey =
  "b15163f0f961a84d6967bee649132e23a5280332ec9b774a2cdac32be6cfc0e1"; // place your private key here (Note: the corresponding wallet must have a non-zero balance of NEON tokens in order to pay for gas fees. Devnet NEON tokens can be obtained for free at https://neonfaucet.org/)
...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      url: "https://rinkeby.infura.io/v3/1c9133d3356f4b97954d8ee90b485b65", // <---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: mnemonic(),
      },
    },
    kovan: {
      url: "https://kovan.infura.io/v3/1c9133d3356f4b97954d8ee90b485b65", // <---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: mnemonic(),
      },
    },
    ...
    ropsten: {
      url: "https://ropsten.infura.io/v3/1c9133d3356f4b97954d8ee90b485b65", // <---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: mnemonic(),
      },
    },
    ...
    mumbai: {
      url:
        "https://polygon-mumbai.g.alchemy.com/v2/jWiiR2MW3b7RsFL1t0LosTx7mlGAYdKs/",
      accounts: {
        mnemonic: mnemonic(),
      },
    },
